...
Visual representations of key structures in the paper.
...
| [`magic-squares.md`](./magic-squares.md) | Six magic squares in QWERTY encoding — Lo Shu, Home Row, Dürer, TXOR, and the 5×5 and 6×6 constant sequences |
